...
def mobilenet_v3_large(num_in_channels: int = 64,
                    #    num_classes: int = 1000,
...
# in_channels = 64
# model = mobilenet_v3_large(num_in_channels=in_channels, reduced_tail=True)
# print(model)
# input_tensor = torch.randn(10, in_channels, 256)
