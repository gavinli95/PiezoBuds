...
class RET(nn.Module):
    def __init__(self, num_classes=8, embedding_size=256, input_dim=40, alpha=0., input_norm='',
...
class RET_v2(nn.Module):
    def __init__(self, num_classes=10, embedding_size=256, input_dim=225, alpha=0., input_norm='',
                 channels=[512, 512, 512, 512, 512, 1536], context=[5, 3, 3, 5],
