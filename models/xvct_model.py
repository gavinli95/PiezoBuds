...
class X_vector(nn.Module):
    def __init__(self, input_dim=225, num_classes=10):
        ...
        self.segment7 = nn.Linear(512, 192)
        self.output = nn.Linear(192, num_classes)
        self.softmax = nn.Softmax(dim=1)

    def forward(self, inputs):
        inputs = inputs.transpose(1, 2)  # [B, T, 225]
...
if __name__ == "__main__":
    ...
    model = X_vector()
    model.to(device)
    print(summary(model, (160, 40)))  # output : [Batch, 512]
