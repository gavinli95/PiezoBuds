...
if __name__ == "__main__":
    ...
    train_data_file_dir = '/mnt/hdd/gen/processed_data/voxceleb1/wav_clips_500ms/train/'
    test_data_file_dir = '/mnt/hdd/gen/processed_data/voxceleb1/wav_clips_500ms/test/'
    ...
    train_data_set = Voxceleb1Dataset(train_data_file_dir, n_user, 4, device=device)
    test_data_set = Voxceleb1Dataset(test_data_file_dir, n_user, 4, device=device)
